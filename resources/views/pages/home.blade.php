    ...
    <main>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="services">
                        <ul class="nav nav-tabs services-links d-flex flex-column justify-content-center" id="myTab"
                            role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="quiz-tab" data-toggle="tab" href="#quiz" role="tab"
                                        ...
                                        <g transform="translate(-17.051)">
                                            <g transform="translate(17.051)">
                                                <g transform="translate(0)">
                                                    <path class="a"
                                                          d="M314.226,308.08a.88.88,0,0,0-.88-.88h-5.281a.88.88,0,1,0,0,1.76h5.281A.88.88,0,0,0,314.226,308.08Z"
                                                          transform="translate(-277.26 -275.515)"/>
                                                    <path class="a"
                                                          d="M326.011,47.948v-4.4a.88.88,0,1,0-1.76,0v4.4a4.406,4.406,0,0,0,4.4,4.4h7.921V69.071a.88.88,0,0,0,1.76,0v-17.6a.88.88,0,0,0-.88-.88h-8.8A2.644,2.644,0,0,1,326.011,47.948Z"
                                                          transform="translate(-292.566 -38.266)"/>
                                                    <path class="a"
                                                          d="M298.038,204.8H291a.88.88,0,1,0,0,1.76h7.041a.88.88,0,0,0,0-1.76Z"
                                                          transform="translate(-261.952 -183.677)"/>
                                                    <path class="a"
                                                          d="M211.826,205.68a.88.88,0,0,0-.88-.88h-5.281a.88.88,0,0,0,0,1.76h5.281A.88.88,0,0,0,211.826,205.68Z"
                                                          transform="translate(-185.422 -183.677)"/>
                                                    <path class="a"
                                                          d="M205.664,256a.88.88,0,1,0,0,1.76h1.76a.88.88,0,0,0,0-1.76Z"
                                                          transform="translate(-185.421 -229.596)"/>
                                                    <path class="a"
                                                          d="M205.664,155.361h8.8a.88.88,0,0,0,0-1.76h-8.8a.88.88,0,0,0,0,1.76Z"
                                                          transform="translate(-185.421 -137.758)"/>
                                                    <path class="a"
                                                          d="M256.864,257.761h8.8a.88.88,0,0,0,0-1.76h-8.8a.88.88,0,0,0,0,1.76Z"
                                                          transform="translate(-231.34 -229.597)"/>
                                                    <path class="a"
                                                          d="M308.064,358.4a.88.88,0,0,0,0,1.76h1.76a.88.88,0,0,0,0-1.76Z"
                                                          transform="translate(-277.259 -321.434)"/>
                                                    <path class="a"
                                                          d="M212.705,307.2h-7.041a.88.88,0,1,0,0,1.76h7.041a.88.88,0,1,0,0-1.76Z"
                                                          transform="translate(-185.421 -275.515)"/>
                                                    <path class="a"
                                                          d="M212.705,358.4h-7.041a.88.88,0,1,0,0,1.76h7.041a.88.88,0,1,0,0-1.76Z"
                                                          transform="translate(-185.421 -321.434)"/>
                                                    <path class="a"
                                                    ...
                                                    <path class="a"
                                                          d="M44.335,51.048H21.452a2.644,2.644,0,0,1-2.64-2.64V4.4a2.644,2.644,0,0,1,2.64-2.64h27.8L57.8,10.3A.88.88,0,0,0,59.04,9.059l-8.8-8.8A.878.878,0,0,0,49.616,0H21.452a4.406,4.406,0,0,0-4.4,4.4V48.408a4.406,4.406,0,0,0,4.4,4.4H44.336a.88.88,0,0,0,0-1.76Z"
                                                          transform="translate(-17.051 0)"/>
                                                    <path class="a"
                                                          d="M212.705,409.6h-7.041a.88.88,0,1,0,0,1.76h7.041a.88.88,0,0,0,0-1.76Z"
                                                          transform="translate(-185.421 -367.353)"/>
                                                    <path class="a"
                                                          d="M109.426,154.48a.88.88,0,0,0-.88-.88h-5.281a.88.88,0,0,0-.88.88v5.281a.88.88,0,0,0,.88.88h5.281a.88.88,0,0,0,.88-.88Zm-1.76,4.4h-3.521V155.36h3.521Z"
                                                          transform="translate(-93.584 -137.757)"/>
                                                    <path class="a"
                                                          d="M103.264,365.442h5.281a.88.88,0,0,0,.88-.88v-5.281a.88.88,0,0,0-.88-.88h-5.281a.88.88,0,0,0-.88.88v5.281A.88.88,0,0,0,103.264,365.442Zm.88-5.281h3.521v3.521h-3.521Z"
                                                          transform="translate(-93.583 -321.435)"/>
                                                    <path class="a"
                                                          d="M104.4,262.779a.881.881,0,0,0,.622.258.715.715,0,0,0,.087,0,.878.878,0,0,0,.645-.387l3.521-5.281a.88.88,0,1,0-1.465-.977l-2.925,4.388-1-1a.88.88,0,1,0-1.245,1.245Z"
                                                          transform="translate(-93.58 -229.592)"/>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="interview-tab" data-toggle="tab" href="#interview" role="tab"
                                   aria-controls="interview" aria-selected="false">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="quiz" role="tabpanel" aria-labelledby="quiz-tab"
                                 style="background-image: url('/img/quiz-bg.jpg')">
                                <div class="tab-body">
                                    <div class="container">
                                        <h1>ПРОЙДИТЕ ОНЛАЙН ТЕСТ НА ПРОФОРИЕНТАЦИЮ</h1>
                                        <p>Тест на профессию подойдет как школьникам, студентам, которые только ищут
                            ...
                            <div class="tab-pane fade" id="training" role="tabpanel" aria-labelledby="training-tab"
                                 style="background-image: url('/img/training-bg.jpg')">
                                <div class="tab-body">
                                    <div class="container">
                                        <h1>ЦЕЛЬ ТРЕНИНГА:</h1>
                                        <p>помочь каждому из участников разобраться в мире профессий и понять, в какой
                                            сфере можно использовать свой потенциал, чтобы в будущем сделать осознанный
                                            самостоятельный выбор.
                                        </p>
                                        <a href="#" class="btn btn-outline-white">Записаться</a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="interview" role="tabpanel" aria-labelledby="interview-tab"
                                 style="background-image: url('/img/interview-bg.jpg')">
                                <div class="tab-body">
                                    <div class="container">
                                        <h1>СОБЕСЕДОВАНИЕ</h1>
                                        <p>Если все-таки не можешь определиться с выбором самостоятельно, у кого следует
                                            просить помощи?
                                            Можно обратиться за личной консультацией психолога, необязательно в
                                            специализированный центр. Консультация психолога будет учитывать не только
                                            профессиональные склонности, но и личностные особенности.
                                        </p>
                                        <a href="#" class="btn btn-outline-white">Записаться</a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="vacancies">
                        <div class="vacancies-resume">Резюме</div>
                        <div class="vacancies-vacancy">Ваканции</div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="after-news">
                        <h1>Образование в вашем округе</h1>
                    </div>
                    <div class="questions">
                        <div class="questions-header">
                            <ul class="nav nav-tabs" id="formsto" role="tablist">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                       aria-haspopup="true" aria-expanded="false">Задать вопрос</a>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#qforms" id="qforms-tab" data-toggle="tab"
                                           role="tab" aria-controls="qforms" aria-selected="true">Задать вопрос</a>
                                        <a class="dropdown-item" href="#cforms" id="cforms-tab" data-toggle="tab"
                                           role="tab" aria-controls="cforms" aria-selected="true">Оставить комментарий</a>
                                        <a class="dropdown-item" href="#sforms" id="sforms-tab" data-toggle="tab"
                                           role="tab" aria-controls="sforms" aria-selected="true">Дать рекомендацию</a>
                                        <a class="dropdown-item" href="#oforms" id="oforms-tab" data-toggle="tab"
                                           role="tab" aria-controls="oforms" aria-selected="true">Другое</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="qforms" role="tabpanel"
                                 aria-labelledby="qforms-tab">
                                <div class="questions-form">
                                    <form method="POST" action="/profile">
                                        @csrf
                                        @if(Auth::check())
                                            <div class="form-group auth">
                                                <textarea name="question" class="form-control" rows="9"
                                ...
                                <div class="questions-form">
                                    <form method="POST" action="/profile">
                                        ...
                                        @if(Auth::check())
                                            <div class="form-group auth">
                                                <textarea name="question" class="form-control" rows="9"
                                                          placeholder="Рекомендация"></textarea>
                                                <button type="submit" class="btn btn-primary">Дать рекомендацию</button>
                                            </div>
                                        @else
                                            <div class="form-group">
                                                <input class="form-control" name="name" type="text" placeholder="Имя">
                ...
                <div class="col-md-8">
                    <div class="featured-professions">
                        <div class="owl-carousel owl-theme professions-owl">
                            @foreach ($professions1 as $profession)
                                <div class="professions-item">
                                    ...
                                    <div class="featured-professions-img"
                                         style="background-image: url('{{$profession->category->getImage()}}');">
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="actually-professions">
                        <div class="col-md-6">
                            <div class="actually-professions-in-kz">
                                <div class="owl-carousel owl-theme actually-professions-owl">
                                    @foreach ($professions2 as $profession)
                                        <div class="professions-item"
                                             style="background-image: url('{{$profession->category->getImage()}}');">
                        ...
                        <div class="col-md-6">
                            <div class="actually-professions-in-region">
                                <div class="owl-carousel owl-theme actually-professions-owl">
                                    @foreach ($professions3 as $profession)
                                        <div class="professions-item"
                                             style="background-image: url('{{$profession->category->getImage()}}');">
                                            <div class="actually-professions-content">
                                                <h1>{{$profession->title}}</h1>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="questions-tab" data-toggle="tab" href="#questions"
                                   role="tab" aria-controls="questions" aria-selected="true">Вопросы</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="comments-tab" data-toggle="tab" href="#comments" role="tab"
                                   aria-controls="comments" aria-selected="false">Комментарий</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="sentences-tab" data-toggle="tab" href="#sentences" role="tab"
                                   aria-controls="sentences" aria-selected="false">Рекомендации</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="other-tab" data-toggle="tab" href="#other" role="tab"
                                   aria-controls="other" aria-selected="false">Другое</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                ...
                <div class="col-md-12">
                    <div class="partners">
                        <div class="partners-inner">
                            <a href="http://egov.kz/cms/ru" class="egov"><img src="/img/egov_logo.png" alt=""></a>
                            <a href="https://www.enbek.kz/ru" class="enbekkz"><img src="/img/enbekkz_logo.png" alt=""></a>
                            <a href="http://www.enbek.gov.kz/ru" class="mintruda"><img src="/img/mintruda_logo.png" alt=""></a>
                            <a href="https://prz.enbek.gov.kz/ru" class="enbek"><img src="/img/enbek_logo.png" alt=""></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="main-footer-form">
                            ...
                            @else
                                <div class="main-footer-user text-center">
                                    <div class="main-footer-user-img">
                                        <img src="{{ Auth::user()->getAvatar() }}" alt="">
                                    </div>
                                    <div class="main-footer-user-name">
