            ...
            <div class="box-body">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputEmail1" min="1" max="20" placeholder="Номер ответа" name="question_number" value="{{old('number')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="answer" id="" cols="30" placeholder="Полный текст" rows="10" class="form-control" value"{{$answer->answer}}"></textarea>
                    </div>
                </div>
            </div>
        </div>
